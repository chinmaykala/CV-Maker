...
?>
    ...
    <head>
        <link type="text/css" rel="stylesheet" href="temp2.css" />
    ...
    <body>
        ...
        <center><button style="border-color: slategrey; border-top: lightgray; border-radius: 100px; padding: 10px 30px; font-size: 1.45em; font-weight: bold; color: grey;" id="printButton" onclick="printButton.style.visibility='hidden'; window.print(printTable); printButton.style.visibility='visible';">Print</button></center>
    </body>
