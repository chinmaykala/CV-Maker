...
?>
    ...
    <head>
        <link type="text/css" rel="stylesheet" href="temp3.css" />
    ...
    <center><button style="border-color: burlywood; border-top: lightgoldenrodyellow; border-radius: 100px; padding: 10px 30px; font-size: 1.45em; font-weight: bold; color: grey;" id="printButton" onclick="printButton.style.visibility='hidden'; window.print(printTable); printButton.style.visibility='visible';">Print</button></center>
    </body>
